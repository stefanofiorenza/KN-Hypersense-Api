...
import com.knits.coreplatform.service.mapper.StatusMapper;
...
class StatusResourceIT {
    ...
    public static Status createEntity(EntityManager em) {
        Status status = new Status().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).uUID(DEFAULT_U_UID);
        return status;
    }
    ...
    public static Status createUpdatedEntity(EntityManager em) {
        Status status = new Status().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).uUID(UPDATED_U_UID);
        return status;
    }
    ...
    void createStatus() throws Exception {
        ...
        assertThat(testStatus.getuUID()).isEqualTo(DEFAULT_U_UID);
    }
    ...
    void putNewStatus() throws Exception {
        ...
        updatedStatus.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).uUID(UPDATED_U_UID);
        ...
        assertThat(testStatus.getuUID()).isEqualTo(UPDATED_U_UID);
    }
    ...
    void partialUpdateStatusWithPatch() throws Exception {
        ...
        partialUpdatedStatus.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).uUID(UPDATED_U_UID);
