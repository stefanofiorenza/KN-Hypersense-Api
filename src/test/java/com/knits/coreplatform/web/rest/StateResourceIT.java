...
import com.knits.coreplatform.repository.StateRepository;
import com.knits.coreplatform.service.dto.StateDTO;
import com.knits.coreplatform.service.mapper.StateMapper;
...
class StateResourceIT {
    ...
    public static State createEntity(EntityManager em) {
        State state = new State().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).uUID(DEFAULT_U_UID);
        return state;
    }
    ...
    public static State createUpdatedEntity(EntityManager em) {
        State state = new State().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).uUID(UPDATED_U_UID);
        return state;
    }
    ...
    void createState() throws Exception {
        ...
        assertThat(testState.getuUID()).isEqualTo(DEFAULT_U_UID);
    }
    ...
    void putNewState() throws Exception {
        ...
        updatedState.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).uUID(UPDATED_U_UID);
        ...
        assertThat(testState.getuUID()).isEqualTo(UPDATED_U_UID);
    }
    ...
    void partialUpdateStateWithPatch() throws Exception {
        ...
        partialUpdatedState.uUID(UPDATED_U_UID);
    ...
    void fullUpdateStateWithPatch() throws Exception {
        ...
        partialUpdatedState.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).uUID(UPDATED_U_UID);
