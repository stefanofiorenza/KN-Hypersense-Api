...
class ApplicationResourceIT {
    ...
    public static Application createEntity(EntityManager em) {
        Application application = new Application().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).isAuthorized(DEFAULT_IS_AUTHORIZED);
        return application;
    }
    ...
    public static Application createUpdatedEntity(EntityManager em) {
        Application application = new Application().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).isAuthorized(UPDATED_IS_AUTHORIZED);
        return application;
    }
    ...
    void createApplication() throws Exception {
        ...
        assertThat(testApplication.getIsAuthorized()).isEqualTo(DEFAULT_IS_AUTHORIZED);
    }
    ...
    void putNewApplication() throws Exception {
        ...
        updatedApplication.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).isAuthorized(UPDATED_IS_AUTHORIZED);
        ...
        assertThat(testApplication.getIsAuthorized()).isEqualTo(UPDATED_IS_AUTHORIZED);
    }
    ...
    void partialUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.name(UPDATED_NAME);
    ...
    void fullUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).isAuthorized(UPDATED_IS_AUTHORIZED);
